...
import { useDeleteSubCatigoriesMutation } from "../../redux/slice/SubCategories/crud.js";


export default function DeleteCategories({ ID }) {
  const [isOpen, setIsOpen] = useState(false);
  const closeModal = () => setIsOpen(false);

  const [deleteCategorie, { isLoading }] = useDeleteSubCatigoriesMutation();
