  ...
  return (
    <div className="  flex h-[70px] items-center  justify-around px-3 w-full pt-[30px]">
      ...
      <ul className="flex justify-around gap-12  ">
        <NavLink className={`span , span1 ${location.pathname === '/' && 'active'}`} to="/"><li>Home</li></NavLink>
        <NavLink className={`span , span2 ${location.pathname === '/contact' && 'active'}`} to="/contact"><li>Contact</li></NavLink>
        <NavLink className={`span , span3 ${location.pathname === '/shop' && 'active'}`} to="/shop"><li>Shop</li></NavLink>
        <NavLink className={`span , span4 ${location.pathname === '/signUp' && 'active'}`} to="/signUp"><li>Sign Up</li></NavLink>
      </ul>
